...
export default (initialState, history, {
  ...
  const getStaticReducers = (history) => {
    staticReducers = {
      global: appReducer,
  ...
  return store = configureStore(getStaticReducers(history), initialState, {
    reducerOptions: {
    ...
    middlewares: [createQuerchyMiddleware(), ...(history ? [routerMiddleware(history)] : []), localStorageMiddleware, createReduxWaitForMiddleware()],
