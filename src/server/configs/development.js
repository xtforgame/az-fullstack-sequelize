...
const secretsFolderForAws = path.join(appRoot, 'secrets');
const awsSecrets = {
  basePath: path.join(secretsFolderForAws, 'aws'),
  config: path.join(secretsFolderForAws, 'aws', 'config.json'),
};
